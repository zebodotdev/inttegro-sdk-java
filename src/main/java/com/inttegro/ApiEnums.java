...
public final class ApiEnums {
    ...
    public static final class PaymentResultStatus { public static final String PENDING = "pending", REQUIRES_CONFIRMATION = "requires_confirmation", PROCESSING = "processing", SUCCEEDED = "succeeded", FAILED = "failed"; private PaymentResultStatus() {} }
